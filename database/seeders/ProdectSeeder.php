...
class ProdectSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Prodect::create($quots04);
        Prodect::create($quots05);
        Prodect::create($quots06);
        Prodect::create($quots07);
        Prodect::create($quots08);
        Prodect::create($quots09);
        Prodect::create($quots10);
        Prodect::create($quots11);
        Prodect::create($quots12);
